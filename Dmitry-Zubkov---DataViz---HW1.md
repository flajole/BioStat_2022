...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_density-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_factor-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_combine-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_region-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_age-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_age_smokers-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_bmi_smokers-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_density1-1.png)<!-- -->

Видно, что распределение сильно смещено влево. Попробуем логарифмическую шкалу, может быть это выровняет распределение.

![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_density2-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_bmi_smokers1-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_obesity_smokers1-1.png)<!-- -->![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_obesity_smokers1-2.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_obesity_smokers2-1.png)<!-- -->

```
## `geom_smooth()` using formula 'y ~ x'
```

![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_obesity_smokers2-2.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_children1-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_children2-1.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_sex-1.png)<!-- -->

```
## `geom_smooth()` using formula 'y ~ x'
```

![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_sex-2.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_region1-1.png)<!-- -->

```
## `geom_smooth()` using formula 'y ~ x'
```

![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/charges_region1-2.png)<!-- -->
...
![](Dmitry-Zubkov---DataViz---HW1_files/figure-html/logcharges_age_bmi-1.png)<!-- -->
